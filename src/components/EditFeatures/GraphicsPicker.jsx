...
const GraphicsPicker = ({ graphicsPickerRef, isGraphicsDragging, closePopup, subActiveOption }) => {
  return (
    <div
      ref={graphicsPickerRef}
      className={`absolute shadow-sm ${
        subActiveOption === "Graphics-Picker" ? "flex" : "hidden"
      } bg-[#FFF] h-80 w-60 flex items-center z-[1000] px-2 mx-auto ${isGraphicsDragging ? "cursor-grab" : "cursor-pointer"}`}
