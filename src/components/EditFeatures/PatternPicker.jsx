...
import { patternLibrary } from "../../utils/dynamicData"

const PatternPicker = ({ isPatternDragging, closePopup, patternPickerRef, subActiveOption }) => {
  return (
    <div
      ...
      <div className="overflow-y-scroll">
        <div className="grid grid-cols-3 gap-4">
          {patternLibrary.map((svg, index) => (
            <div key={index} className="flex just3ify-center items-center hide-scrollbar">
              <div
                style={{
                  width: "150px",
                  height: "100px",
